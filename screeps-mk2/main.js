    ...
    if(true) {
        ...
        for(var name in Memory.creeps) {
            if(!Game.creeps[name]) {
                ...
                if(Memory.creeps[name].role == "Claimer" && Memory.RoomsToClaim[Memory.creeps[name].targetRoomID] == 2) {//reversing
        ...
        console.log("[Spawn Log]Miner:" + Memory.MinerNum, "Carrier:" + Memory.CarrierNum,
