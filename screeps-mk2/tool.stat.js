...
var stat = {
    run: function(room) {
        ...
        if(typeof Memory.EnergyTrack == "undefined") {
            Memory.EnergyTrack = [];
            Memory.Energy10TickSum1 = 0, Memory.Energy100TickSum1 = 0, Memory.Energy500TickSum1 = 0, Memory.Energy1000TickSum1 = 0;
            Memory.Energy10TickSum2 = 0, Memory.Energy100TickSum2 = 0, Memory.Energy500TickSum2 = 0, Memory.Energy1000TickSum2 = 0;
            Memory.Energy10TickTrend = 0, Memory.Energy100TickTrend = 0, Memory.Energy500TickTrend = 0, Memory.Energy1000TickTrend = 0;
        }
        Memory.EnergyTrack.unshift(energy);
        if(Memory.EnergyTrack.length < 2000 || Game.time % 10000 == 1001) {
            while(Memory.EnergyTrack.length > 2000) {
                Memory.EnergyTrack.pop();
            }
            var sum101 = 0, sum1001 = 0, sum5001 = 0, sum10001 = 0;
            var sum102 = 0, sum1002 = 0, sum5002 = 0, sum10002 = 0;
            var i = 0
            ...
            Memory.Energy10TickSum1 = sum101, Memory.Energy100TickSum1 = sum1001, Memory.Energy500TickSum1 = sum5001, Memory.Energy1000TickSum1 = sum10001;
            Memory.Energy10TickSum2 = sum102, Memory.Energy100TickSum2 = sum1002, Memory.Energy500TickSum2 = sum5002, Memory.Energy1000TickSum2 = sum10002;
        }
        else {
            ...
            Memory.Energy1000TickSum2 = Memory.Energy1000TickSum2 + Memory.EnergyTrack[1000] - Memory.EnergyTrack.pop();
        }
